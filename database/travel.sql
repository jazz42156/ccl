...
(22, 'Entertainment Themed Vacations', 6, 21, 100000, '101.jpg', '100.jpg', '102.jpg', 'At MR^2we create custom designed entertainment themed vacation packages based on your specific interests making each trip unique. MR^2will give you an idea of the types of packages that could be possible for an entertainment-themed holiday.'),
