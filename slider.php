			...
			<div id="section-1" class="section">
			    <div id="top" class="callbacks_container">
			      <ul class="rslides" id="slider4">
			        <li>
			          <img src="images/msl1.jpg" alt="">
					  <div class="caption">
			     	  		<div class="header-info">
							<h2><a href="#">Get Away On This Weekend</a></h2>
							<lable></lable>
							<h1><a href="#">PARADISE RESORT</a></h1>
							</div>
			          </div>
			        </li>
			        <li>
			          <img src="images/msl2.jpg" alt="">
			        <div class="caption">
			          	<div class="header-info">
							<h2><a href="#">Experience Something Thrilling</a></h2>
							<lable></lable>
							<h1><a href="#">ENJOY SKYDIVING</a></h1>
							</div>
			          </div>
			        </li>
			        <li>
			          <img src="images/msl4.jpg" alt="">
			          <div class="caption">
			          	<div class="header-info">
							<h2><a href="#">Get Away On This Weekend</a></h2>
							<lable></lable>
