		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">MR^2 Enterprises</h4>
						<p style="color:#000">NEED HELP BOOKING PACKAGE<br/>
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+91) 9436258821&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;(+91) 7696303090</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">info@MR^2.com&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;support[at]MR^2.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>B-5,Mellora Residence, New delhi.</h5>
                        <br/>
